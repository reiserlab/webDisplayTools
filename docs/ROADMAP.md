...
- Frame animation mode and sequence builder
- Pattern combiner (A op B)
- .pat file load/save (G4, G4.1, G6 with Header V1 and V2)

### Known Issues (#28)
- Changing arena doesn't clear 3D viewer
- Edge patterns make too many frames vs MATLAB
- Animate from frame uses wrong clipboard frame
- Animate sequence UI: icons too small, needs vertical filmstrip layout
- Pattern combine: show clipboard pattern visualization with mouseover
