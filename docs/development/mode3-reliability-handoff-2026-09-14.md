...
**Candidate build:** firmware **`feat/mode3-reliability` @ `781efe2`** (`488d5b9` + a second panel blank at the end of setup) — the stack on `main` (Frank's per-board scheme,
PR #48) with a 2×10 variant; build `pio run -e teensy41-2-10-performance`, label `781efe2b 2x10 … freerun sdfast`, 0xCB
